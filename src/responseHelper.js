...
var responseHelper = (function () {
    ...
    var handleWelcome = function (response) {
        var cardTitle = "Inspire Me",
            speechOutput = "Welcome to Inspire Me!  Would you like to hear an inspirational quote?",
            repromptOutput = "With Inspire Me, you can hear an inspirational quote",
            cardOutput = "Inspire Me. Would you like to hear an inspirational quote?";
     ...
     * @param response - the response to add help to
     */
